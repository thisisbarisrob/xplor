...
function fixTextBox(){
  var html_editor = $(".tox.tox-tinymce");
  if (html_editor.length == 0){
    setTimeout(function(){fixTextBox();},500);
  }
  html_editor.addClass("mce-tinymce mce-container mce-panel focused");
  html_editor.height("504");
  $("a.nav-link.mode-html.active").attr("onclick","fixTextBox()");
}
